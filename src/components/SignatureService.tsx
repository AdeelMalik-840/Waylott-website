...
function StepCard({
  ...
  return (
    ...
    >
      ...
      {/* optional pill */}
      {optional && (
        <span className="mt-3 inline-flex items-center rounded-full bg-gray-200 px-3 py-1 text-xs text-gray-800" role="status" aria-label="Optional service">
          Optional
        </span>
      )}
...
export default function SignatureService() {
  return (
    <section id="signature-service" className="relative overflow-hidden py-16">
      ...
      <div className="mx-auto max-w-[1120px] px-6 relative z-10">
        ...
        <Reveal animation="fade-up">
          <h2 className="text-center text-3xl sm:text-4xl font-extrabold text-[#000000] mb-4 relative z-0">
            Waylott&apos;s Signature Service
          </h2>
        </Reveal>

        <Reveal animation="fade-up" delay={50}>
          <p className="mx-auto mt-4 max-w-3xl text-center text-lg leading-7 text-gray-600 relative z-0">
