...
import { ChartLine, Target, Rocket } from "lucide-react";
  ...
  return (
    <section id="about" className="relative overflow-hidden py-14 md:py-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Phases Row (staggered, premium motion) */}
...
/**
 * Subtle Apple/Stripe-like 3D tilt on hover, springy and reduced-motion safe.
 * Wraps each phase card without changing its layout.
 */
...
function StepCard({
  ...
  return (
    <div className="relative flex flex-col items-center h-full w-full">
      ...
      >
        {/* Icon with subtle shimmer on hover */}
        <motion.div
        ...
        {optional && (
          <span className="mb-1 inline-flex items-center rounded-full bg-white/90 px-3 py-0.5 text-[11px] font-medium text-slate-700 ring-1 ring-slate-200">
            Optional
          </span>
        )}
  ...
  return (
    <div className="shrink-0 flex items-center justify-center my-2 md:my-0">
      <svg
        ...
        className="text-[#1D573D] rotate-90 md:rotate-0 transition-transform"
      >
